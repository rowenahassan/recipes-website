...
function displayRecipe(recipe) {
  ...
  document.getElementById("recipe-img").src = recipe.imageSrc;
  document.getElementById("recipe-img").alt = recipe.imageAlt;
  document.getElementById("prep-time").innerHTML = recipe.prepTime + " min";
  document.getElementById("cook-time").innerHTML = recipe.cookTime + " min";
  document.getElementById("time-warning").style.display =
    recipe.prepTime + recipe.cookTime > 45 ? "block" : "none";
  document.getElementById("servings").innerHTML = recipe.servings + " people";
  document.getElementById("recipe-rating").innerHTML = recipe.rating;
  document.getElementById(
    "recipe-review"
  ).innerHTML = `(${recipe.reviews} reviews)`;
  document.getElementById("difficulty-badge").innerHTML = recipe.difficulty;
  document.getElementById("category-badge").innerHTML = recipe.category;

  let ingredients = "";
  for (let i = 0; i < recipe.ingredients.length; i++) {
    ingredients += `<li class="d-flex align-items-start">
                      <div class="number rounded-circle d-flex align-items-center justify-content-center text-white text-xs fw-bold flex-shrink-0">
                        ${i + 1}
                      </div>
  ...
  for (let i = 0; i < recipe.instructions.length; i++) {
    instructions += `<div class="steps d-flex align-items-start mb-4">
                      <div class="number me-3 d-flex align-items-center justify-content-center text-white text-xl fw-bold flex-shrink-0">
                        ${i + 1}
                      </div>
                      <div class="step pt-2">
                        <p class="mb-0">${recipe.instructions[i]}</p>
                      </div>
                    </div>`;
  }
  ...
  document.getElementById("protein-value").innerHTML = recipe.nutrition.protein;
  document.getElementById("carbs-value").innerHTML = recipe.nutrition.carbs;
  document.getElementById("fat-value").innerHTML = recipe.nutrition.fat;
  document.getElementById("fiber-value").innerHTML = recipe.nutrition.fiber;
  document.getElementById("sodium-value").innerHTML = recipe.nutrition.sodium;

  let tips = "";
  for (let i = 0; i < recipe.tips.length; i++) {
    tips += `<div class="d-flex align-items-start p-3 mb-3">
               <i class="fa-solid fa-circle-check text-xl mt-1" style="color: #e17100"></i>
               <p class="mb-0">${recipe.tips[i]}</p>
             </div>`;
  }
